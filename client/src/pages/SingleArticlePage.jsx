...
const SingleArticlePage = () => {
  ...
  useEffect(() => {
    ...
    const fetchOneArticle = async () => {
      try {
        const response = await fetch(`https://craftify-ekc4.onrender.com/api/articles/article/${articleId}`, {
          method: 'GET',
          headers: {
    ...
    const fetchArticles = async (userId) => {
      try {
        const response = await fetch(`https://craftify-ekc4.onrender.com/api/articles/user/${userId}/articles`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json'
          }
  ...
  const handleAddToFavorites = async () => {
    try {
      const response = await fetch('https://craftify-ekc4.onrender.com/api/favorite', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${localStorage.getItem('authToken')}`
