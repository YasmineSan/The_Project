...
export const ShowArticlesSection = () => {
  ...
  return (
    <section className="container mx-auto py-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10"> {/* Augmentation de l'espace entre les colonnes */}
        <div className="flex flex-col justify-center items-start p-4 rounded-lg shadow-lg">
          <h1 className="text-2xl font-semibold mb-4">Découvrez nos articles</h1>
