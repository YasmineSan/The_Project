...
export const CategorySection = () => {
  ...
  const categories = [
    { id: 5, name: 'Forge', image: '/images/categories/categorie-forge.jpg' },
    { id: 6, name: 'Bois', image: '/images/categories/categorie-bois.jpg' },
    { id: 15, name: 'Couture', image: '/images/categories/categorie-couture.jpg' },
            ...
            {Array.from({ length: totalPages }).map((_, pageIndex) => (
              <div key={pageIndex} className="flex-shrink-0 w-full flex">
                {categories.slice(pageIndex * itemsPerPage, (pageIndex + 1) * itemsPerPage).map((category) => (
                  ...
                  >
                    <div className="rounded-full w-52 h-52 overflow-hidden mb-2">
