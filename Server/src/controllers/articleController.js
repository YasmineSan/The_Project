...
exports.addArticle = async (req, res) => {
    try {
        ...
        try {
            ...
            let [categoryResult] = await connection.execute('SELECT category_id FROM Categories WHERE category_name = ?', [category_name]);
            ...
            const [articleResult] = await connection.execute(
                ...
                [title, article_description, article_price, shipping_cost, category_id, article_photo_url, new Date()]
            );
    ...
    try {
        ...
        try {
            ...
            await connection.execute(
                ...
                WHERE article_id = ?`,
                [title, article_description, article_price, shipping_cost, category_name, article_photo_url, articleId]
            );
...
exports.getAllArticlePrices = async (req, res) => {
    try {
        ...
        try {
            const [result] = await connection.execute('SELECT article_id, article_price FROM Articles');
            res.json(result);
        } finally {
            connection.release();
        }
